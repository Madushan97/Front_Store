# Generated by Django 4.0.1 on 2022-01-26 05:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Failed')], default=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Failed')], max_length=1)),
